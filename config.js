...
global.gurl = process.env.GURL || "https://chat.whatsapp.com/IWHf2xmxv072S52FXfEVPB";
global.website = process.env.GURL || "https://chat.whatsapp.com/IWHf2xmxv072S52FXfEVPB";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘-𝕹𝖆𝖎𝖗𝖔𝖇𝖎𝖆𝖓 𝖌𝖔𝖔𝖓 with supported by he.is.me checked by Wasi-ser | oyyy enjoy safe chuddy buddy any problem then https://rb.gy/izabex | don't worry we are not here to ban your accounts 😁 🦜🌝 ( https://rb.gy/izabex )",
  author: process.env.PACK_AUTHER || "𝕹𝖆𝖎𝖗𝖔𝖇𝖎𝖆𝖓 𝖌𝖔𝖔𝖓",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "𝕹𝖆𝖎𝖗𝖔𝖇𝖎𝖆𝖓 𝖌𝖔𝖔𝖓",
